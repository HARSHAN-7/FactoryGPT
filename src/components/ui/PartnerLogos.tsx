...
export function PartnerLogos() {
  return (
    <div className="flex flex-wrap items-center gap-6 sm:gap-8 pt-2">
      {/* Siemens Logo */}
      <div title="Siemens Industrial Automation" className="h-7 opacity-75 hover:opacity-100 transition-opacity flex items-center">
      ...
      {/* ABB Logo */}
      <div title="ABB Robotics & Power" className="h-7 opacity-75 hover:opacity-100 transition-opacity flex items-center">
      ...
      {/* TATA Logo */}
      <div title="Tata Group Industry" className="h-7 opacity-75 hover:opacity-100 transition-opacity flex items-center gap-1.5">
        ...
        <span className="font-extrabold text-sm sm:text-base font-sans tracking-widest text-[#003366] dark:text-[#38bdf8]">
          TATA
        </span>
      </div>

      {/* Honeywell Logo */}
      <div title="Honeywell Industrial Safety" className="h-7 opacity-75 hover:opacity-100 transition-opacity flex items-center">
      ...
      <div title="Schneider Electric Automation" className="h-7 opacity-75 hover:opacity-100 transition-opacity flex items-center gap-2">
        ...
        <span className="font-extrabold text-xs sm:text-sm font-sans tracking-tight text-[#3DCD58]">
          Schneider <span className="font-normal text-industrial-300">Electric</span>
        </span>
      </div>
    </div>
  );
