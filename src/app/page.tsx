          ...
          <div className="w-full max-w-md space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs font-mono text-gold-500 font-semibold">
                ● INDUSTRIAL OPERATOR AUTHENTICATION GATE
              </p>
            ...
            <Card className="bg-industrial-900 border-industrial-800 p-6 shadow-2xl space-y-6 gold-glow">
              ...
              {/* Error Banner */}
              {errorMsg && (
                <div className="p-3.5 bg-red-950/90 border border-red-800 rounded-lg text-xs font-mono text-red-200 flex items-start gap-2.5 shadow-md text-left">
              ...
              {activeTab === 'email' && (
                <form onSubmit={handleEmailAuth} className="space-y-4 text-xs font-mono">
                  ...
                  <div className="space-y-1 text-left">
                    <label className="text-industrial-300 block">Password (min. 6 characters)</label>
                    <Input
                      type="password"
                      placeholder="••••••••••••"
                      value={password}
              ...
              {activeTab === 'google' && (
                <div className="space-y-4 py-4 text-center">
                  <p className="text-xs text-industrial-400 font-mono">
                    Official Google Identity & Account Chooser OAuth Flow.
                  </p>
                  <button
                    type="button"
